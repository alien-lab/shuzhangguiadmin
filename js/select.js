...
//select2
shuzhanggui.directive('select2', function (select2Query) {
   return {
      restrict: 'A',
      scope: {
         config: '=',
 ...
 * select2 内置查询功能
 */
shuzhanggui.factory('select2Query', function ($timeout) {
   return {
      testAJAX: function () {
         var config = {
...
shuzhanggui.controller('borrowbookController', function ($scope, $timeout) {
   $scope.config1 = {
      data: [],
      placeholder: '尚无数据'
   };
